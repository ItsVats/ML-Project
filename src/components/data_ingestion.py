...
class DataIngestion:
    def __init__(self):
        ...
        self.ingestion_config.train_data_path = str(artifacts_dir / 'train.csv')
        self.ingestion_config.test_data_path = str(artifacts_dir / 'test.csv')
        self.ingestion_config.raw_data_path = str(artifacts_dir / 'data.csv')
